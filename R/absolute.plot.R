absolute.plot <- function(nma.obj, alphabetic = TRUE, digits = 2, save = TRUE, width = 5, height, network.name){
  ...
  plot(x = c(low,upp), y = rep(rev(1:ntrt), 2), ylim = c(0.8, ntrt), frame.plot = FALSE, yaxt = "n", xlab = armparam, ylab = "", type = "n")
